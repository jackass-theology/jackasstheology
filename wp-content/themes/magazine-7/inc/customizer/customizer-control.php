 ...
 */
class Magazine_7_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label>
            ...
            <select <?php $this->link(); ?>>
                <?php
                printf( '<option value="%s" %s>%s</option>', 0, selected( $this->value(), '', false ), __( 'All', 'magazine-7' )  );
                ?>
 ...
 * @see WP_Customize_Control
 */
class Magazine_7_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Magazine_7_Customize_Section_Upsell extends WP_Customize_Section {
