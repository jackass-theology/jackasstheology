...
// Prevent Wordpress from looking in the database for the SITEURL and HOME
define('WP_SITEURL', 'http://localhost:8888/jackasstheology');
define('WP_HOME', 'http://localhost:8888/jackasstheology');
